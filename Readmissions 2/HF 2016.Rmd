...
HFRace <- data.frame(
  ...
  Black = percent(as.numeric(c(
    ...
    HF_vis %>% filter(Race == "ASIAN") %>% count() / vtotal,
    HF_read %>% filter(Race == "ASIAN") %>% count() / rtotal
  ))),
    Unknown = percent(as.numeric(c(
    HF_vis %>% filter(Race == "UNKNOWN") %>% count() / vtotal,
    HF_read %>% filter(Race == "UNKNOWN") %>% count() / rtotal
  ))),
    Indian = percent(as.numeric(c(
    HF_vis %>% filter(Race == "AM INDIAN/AK NATIVE") %>% count() / vtotal,
    HF_read %>% filter(Race == "AM INDIAN/AK NATIVE") %>% count() / rtotal
  ))),
  Ref = percent(as.numeric(c(
    HF_vis %>% filter(Race == "REFUSES TO ANSWER") %>% count() / vtotal,
    HF_read %>% filter(Race == "REFUSES TO ANSWER") %>% count() / rtotal
  )))
)
...
HFType <- data.frame(
  ...
  Trauma = percent(as.numeric(c(
    HF_vis %>% filter(Admit.Type == "TRAUMA") %>% count() / vtotal,
    HF_read %>% filter(Admit.Type == "TRAUMA") %>% count() / rtotal
  )))
)
